  ...
  <UContainer class="py-12 sm:py-16">
    ...
    <div class="mx-auto mt-10 max-w-3xl space-y-10 text-lg/8 text-toned">
      ...
      <section class="space-y-4">
        ...
        <p>
          All books published by Dorean Press are dedicated to the public domain. You can copy, translate, modify, and distribute all resources, without restriction, and without needing to ask permission. All resources are freely given (Matt 10:8) for the sake of the gospel.
        </p>
